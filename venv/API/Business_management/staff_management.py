...
def phone3():
    prelist = ["130", "131", "132", "133", "134", "135", "136", "137", "138", "139",
            ...
            "186", "187", "188", "189"]
    phone3 = random.choice(prelist) + "".join(random.choice("0123456789")for i in range(8))
    return phone3
# print(phone3())
...
def id_card3():
    ...
    id_card3 = number+str(code_number)
    # print(id_card)
    return id_card3
...
def random_add_salesman():
    ...
    if res.status_code == 200:
        return print(res.status_code),print(res.text)
    else:
